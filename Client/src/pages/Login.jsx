    ...
    <div className='bg-[url("login_bg.jpg")] h-screen bg-center repeat flex items-center justify-center '>
      <div className="absolute inset-0 bg-black/50">
       ...
       <div className="relative z-10 w-[900px] h-[600px] bg-white rounded-lg shadow-lg flex flex-row items-center justify-center">
         <div className="w-[40%] h-[100%] bg-[url('login_hero.jpg')] bg-cover bg-center rounded-lg">
         ...
         <div className="w-[60%] h-[100%] flex flex-col items-center justify-center ">
              <h1 className="text-3xl font-bold mb-6">Login</h1>
                <form className="w-full max-w-sm h-[80%] flex flex-col items-center justify-center ">
                    <div className="mb-4 w-full  h-[20%] flex flex-col items-start justify-center pl-4">
                    ...
                    <div className="mb-4 w-full  h-[15%] flex flex-col items-start justify-center pl-4">
                   ...
                   <div className="w-full  h-[15%] flex flex-col items-center justify-start gap-4">
                        <a className="inline-block text-start align-baseline text-sm text-red-600 hover:text-red-400" href="#">
                            Forgot Password?
                        </a>
                        <p className="inline-block text-center align-baseline  text-sm text-black ">Don't have an account? <a href="#" className="text-blue-500 hover:text-blue-800 cursor-pointer">Sign Up</a></p>
                    </div>
